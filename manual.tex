...
\setcounter{enumi}{-1}
\item
Install either MLton or Standard ML of New Jersey.

\item
Download the distribution:

\url{http://www.cs.cmu.edu/~crary/cmtool/cmtools.tgz}
...
bin/cmlex
mv bin/cmlex \nonterm{location where you want cmlex installed}
cd ..
\end{code}

\item
Build CM-Lex for Haskell.
...
bin/cmlex-hs
mv bin/cmlex-hs \nonterm{location where you want cmlex-hs installed}
cd ..
\end{code}

\item
Build CM-Yacc for Standard ML.
...
bin/cmyacc
mv bin/cmyacc \nonterm{location where you want cmyacc installed}
cd ..
\end{code}

\item
Build CM-Yacc for Haskell
...
bin/cmyacc-hs
mv bin/cmyacc-hs \nonterm{location where you want cmyacc-hs installed}
cd ..
\end{code}
\end{enumerate}
