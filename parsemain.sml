...
type directive
type directives
val ident : pos_string -> string
val number : pos_int -> int
...
val string_regexp : pos_intlist -> regexp
...
(5,1,(fn Value.pos_intlist(arg0)::rest => Value.regexp(Arg.string_regexp arg0)::rest|_=>raise (Fail "bad parser"))),
