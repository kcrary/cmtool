...
type directive
type directives
val ident : {ident:pos_string} -> string
val number : {num:pos_int} -> int
val nil_numpairs : {} -> numpairs
val cons_numpairs : {first:int, last:int, tail:numpairs} -> numpairs
val ident_charset : {ident:string} -> charset
val number_charset : {num:int} -> charset
...
val ident_regexp : {ident:string} -> regexp
val number_regexp : {num:int} -> regexp
...
val enable_directive : {ident:string} -> directive
val alphabet_directive : {num:int} -> directive
val regexp_directive : {ident:string, r:regexp} -> directive
val set_directive : {ident:string, s:charset} -> directive
val function_directive : {ident:string, tp:string, arms:arms} -> directive
...
Vector.fromList [(0,1,(fn Value.pos_string(arg0)::rest => Value.string(Arg.ident {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(1,1,(fn Value.pos_int(arg0)::rest => Value.int(Arg.number {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(2,0,(fn rest => Value.numpairs(Arg.nil_numpairs {})::rest)),
(2,3,(fn Value.numpairs(arg0)::Value.int(arg1)::Value.int(arg2)::rest => Value.numpairs(Arg.cons_numpairs {tail=arg0,last=arg1,first=arg2})::rest|_=>raise (Fail "bad parser"))),
(3,1,(fn Value.string(arg0)::rest => Value.charset(Arg.ident_charset {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,1,(fn Value.int(arg0)::rest => Value.charset(Arg.number_charset {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,4,(fn _::Value.numpairs(arg0)::_::_::rest => Value.charset(Arg.range_charset {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,1,(fn _::rest => Value.charset(Arg.empty_charset {})::rest|_=>raise (Fail "bad parser"))),
(3,4,(fn _::Value.charsets(arg0)::_::_::rest => Value.charset(Arg.union_charset {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,4,(fn _::Value.charsets(arg0)::_::_::rest => Value.charset(Arg.intersect_charset {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,5,(fn _::Value.charsets(arg0)::Value.charset(arg1)::_::_::rest => Value.charset(Arg.diff_charset {l=arg0,head=arg1})::rest|_=>raise (Fail "bad parser"))),
(3,4,(fn _::Value.charsets(arg0)::_::_::rest => Value.charset(Arg.comp_charset {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(3,1,(fn _::rest => Value.charset(Arg.any_charset {})::rest|_=>raise (Fail "bad parser"))),
(4,0,(fn rest => Value.charsets(Arg.nil_charsets {})::rest)),
(4,2,(fn Value.charsets(arg0)::Value.charset(arg1)::rest => Value.charsets(Arg.cons_charsets {tail=arg0,head=arg1})::rest|_=>raise (Fail "bad parser"))),
(5,1,(fn Value.string(arg0)::rest => Value.regexp(Arg.ident_regexp {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,1,(fn Value.int(arg0)::rest => Value.regexp(Arg.number_regexp {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,1,(fn Value.pos_intlist(arg0)::rest => Value.regexp(Arg.string_regexp {str=arg0})::rest|_=>raise (Fail "bad parser"))),
...
(5,4,(fn _::Value.regexps(arg0)::_::_::rest => Value.regexp(Arg.concat_regexp {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,4,(fn _::Value.regexps(arg0)::_::_::rest => Value.regexp(Arg.seq_regexp {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,4,(fn _::Value.regexps(arg0)::_::_::rest => Value.regexp(Arg.union_regexp {l=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,4,(fn _::Value.regexp(arg0)::_::_::rest => Value.regexp(Arg.option_regexp {r=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,4,(fn _::Value.regexp(arg0)::_::_::rest => Value.regexp(Arg.closure_regexp {r=arg0})::rest|_=>raise (Fail "bad parser"))),
(5,4,(fn _::Value.regexp(arg0)::_::_::rest => Value.regexp(Arg.plus_regexp {r=arg0})::rest|_=>raise (Fail "bad parser"))),
...
(6,2,(fn Value.regexps(arg0)::Value.regexp(arg1)::rest => Value.regexps(Arg.cons_regexps {tail=arg0,head=arg1})::rest|_=>raise (Fail "bad parser"))),
(7,3,(fn Value.string(arg0)::_::Value.regexp(arg1)::rest => Value.arm(Arg.sole_arm {action=arg0,r=arg1})::rest|_=>raise (Fail "bad parser"))),
(8,1,(fn Value.arm(arg0)::rest => Value.arms(Arg.sing_arms {arm=arg0})::rest|_=>raise (Fail "bad parser"))),
(8,2,(fn Value.arms(arg0)::Value.arm(arg1)::rest => Value.arms(Arg.cons_arms {tail=arg0,head=arg1})::rest|_=>raise (Fail "bad parser"))),
(9,2,(fn Value.string(arg0)::_::rest => Value.directive(Arg.name_directive {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(9,2,(fn Value.string(arg0)::_::rest => Value.directive(Arg.enable_directive {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(9,2,(fn Value.int(arg0)::_::rest => Value.directive(Arg.alphabet_directive {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(9,4,(fn Value.regexp(arg0)::_::Value.string(arg1)::_::rest => Value.directive(Arg.regexp_directive {r=arg0,ident=arg1})::rest|_=>raise (Fail "bad parser"))),
(9,4,(fn Value.charset(arg0)::_::Value.string(arg1)::_::rest => Value.directive(Arg.set_directive {s=arg0,ident=arg1})::rest|_=>raise (Fail "bad parser"))),
(9,6,(fn Value.arms(arg0)::_::Value.string(arg1)::_::Value.string(arg2)::_::rest => Value.directive(Arg.function_directive {arms=arg0,tp=arg1,ident=arg2})::rest|_=>raise (Fail "bad parser"))),
(10,0,(fn rest => Value.directives(Arg.nil_directives {})::rest)),
(10,2,(fn Value.directives(arg0)::Value.directive(arg1)::rest => Value.directives(Arg.cons_directives {tail=arg0,head=arg1})::rest|_=>raise (Fail "bad parser")))],
