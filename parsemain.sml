...
(10,1,(fn Value.pos_int(arg0)::rest => Value.int(Arg.number {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(1,0,(fn rest => Value.numpairs(Arg.nil_numpairs {})::rest)),
(1,3,(fn Value.numpairs(arg0)::Value.int(arg1)::Value.int(arg2)::rest => Value.numpairs(Arg.cons_numpairs {tail=arg0,last=arg1,first=arg2})::rest|_=>raise (Fail "bad parser"))),
(2,1,(fn Value.string(arg0)::rest => Value.charset(Arg.ident_charset {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(2,1,(fn Value.int(arg0)::rest => Value.charset(Arg.number_charset {num=arg0})::rest|_=>raise (Fail "bad parser"))),
...
(4,1,(fn Value.string(arg0)::rest => Value.regexp(Arg.ident_regexp {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(4,1,(fn Value.int(arg0)::rest => Value.regexp(Arg.number_regexp {num=arg0})::rest|_=>raise (Fail "bad parser"))),
...
(6,3,(fn Value.string(arg0)::_::Value.regexp(arg1)::rest => Value.arm(Arg.sole_arm {action=arg0,r=arg1})::rest|_=>raise (Fail "bad parser"))),
...
(8,2,(fn Value.string(arg0)::_::rest => Value.directive(Arg.name_directive {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(8,2,(fn Value.string(arg0)::_::rest => Value.directive(Arg.enable_directive {ident=arg0})::rest|_=>raise (Fail "bad parser"))),
(8,2,(fn Value.int(arg0)::_::rest => Value.directive(Arg.alphabet_directive {num=arg0})::rest|_=>raise (Fail "bad parser"))),
(8,4,(fn Value.regexp(arg0)::_::Value.string(arg1)::_::rest => Value.directive(Arg.regexp_directive {r=arg0,ident=arg1})::rest|_=>raise (Fail "bad parser"))),
(8,4,(fn Value.charset(arg0)::_::Value.string(arg1)::_::rest => Value.directive(Arg.set_directive {s=arg0,ident=arg1})::rest|_=>raise (Fail "bad parser"))),
(8,6,(fn Value.arms(arg0)::_::Value.string(arg1)::_::Value.string(arg2)::_::rest => Value.directive(Arg.function_directive {arms=arg0,tp=arg1,ident=arg2})::rest|_=>raise (Fail "bad parser"))),
