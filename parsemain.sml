...
| Arg.FOLLOWER x => (6, Value.pos x)
| Arg.NAME x => (7, Value.pos x)
| Arg.NONTERMINAL x => (8, Value.pos x)
| Arg.NOPREC x => (9, Value.pos x)
| Arg.LPAREN x => (10, Value.pos x)
| Arg.OF x => (11, Value.pos x)
| Arg.PRECL x => (12, Value.pos x)
| Arg.PRECR x => (13, Value.pos x)
| Arg.RPAREN x => (14, Value.pos x)
| Arg.START x => (15, Value.pos x)
| Arg.TERMINAL x => (16, Value.pos x)
)
)
in
